...
final class scroller extends Application
{
    /**
     ...
     * @return void
     */
    private function ajaxResponse(): void
    {
        ...
        parent::setContentData([
            'stars' => [
                ...
                'style' => [
                    ...
                    'color' => ['white', 'grey', 'lightgrey', 'lightyellow', 'lightblue'],
                    'opacity' => [0.1, 0.3, 0.5, 0.7],
                ],
            ],
            'text' => [
